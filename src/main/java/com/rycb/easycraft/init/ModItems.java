...
import com.rycb.easycraft.util.SimpleCalculator;
...
public class ModItems {
    ...
    public static final ItemArmor.ArmorMaterial ARMOR_MATERIAL_CLAD_METAL = EnumHelper.addArmorMaterial("clad_metal", Reference.MOD_ID + ":cm", 75, new int[]{8, 20, 27, 10}, 71, SoundEvents.ENTITY_WITHER_SHOOT, 2.0f);
    ...
    public static final Item.ToolMaterial TOOL_MATERIAL_CLAD_METAL = EnumHelper.addToolMaterial("cm", 6, 8132, 20.0f, 12.0f, 89);
    ...
    public static final Item CLAD_METAL_HELMET = new ArmorBase(true, ARMOR_MATERIAL_CLAD_METAL, 1, EntityEquipmentSlot.HEAD, "helmetCM", "clad_metal_helmet", EasyCraft.EC_TAB, EPIC);
    public static final Item CLAD_METAL_CHESTPLATE = new ArmorBase(true, ARMOR_MATERIAL_CLAD_METAL, 1, EntityEquipmentSlot.CHEST, "cplateCM", "clad_metal_chestplate", EasyCraft.EC_TAB, EPIC);
    public static final Item CLAD_METAL_LEGGINGS = new ArmorBase(true, ARMOR_MATERIAL_CLAD_METAL, 2, EntityEquipmentSlot.LEGS, "leggingsCM", "clad_metal_leggings", EasyCraft.EC_TAB, EPIC);
    public static final Item CLAD_METAL_BOOTS = new ArmorBase(true, ARMOR_MATERIAL_CLAD_METAL, 1, EntityEquipmentSlot.FEET, "bootsCM", "clad_metal_boots", EasyCraft.EC_TAB, EPIC);
    public static final Item CLAD_METAL_AXE = new ToolAxe(true, TOOL_MATERIAL_CLAD_METAL, "CM", EasyCraft.EC_TAB, EPIC);
    public static final Item CLAD_METAL_PICKAXE = new ToolPickaxe(true, TOOL_MATERIAL_CLAD_METAL, "CM", EasyCraft.EC_TAB, EPIC);
    public static final Item CLAD_METAL_SWORD = new ToolSword(true, TOOL_MATERIAL_CLAD_METAL, "CM", EasyCraft.EC_TAB, EPIC);
    public static final Item CLAD_METAL_HOE = new ToolHoe(true, TOOL_MATERIAL_CLAD_METAL, "CM", EasyCraft.EC_TAB, EPIC);
    public static final Item CLAD_METAL_SHOVEL = new ToolShovel(true, TOOL_MATERIAL_CLAD_METAL, "CM", EasyCraft.EC_TAB, EPIC);
    ...
    public static final Item CM_INGOT = new ItemIngotBase("CM", "clad_metal", EasyCraft.EC_TAB, RARE);
}
